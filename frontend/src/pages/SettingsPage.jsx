...
const DECORATIONS = {
  ...
  frames: [
    ...
    { id: 10, name: 'Неоновый Розовый', img: '/frames/neon_pink.svg', type: 'frame', price: 1500 },
    { id: 11, name: 'Неоновый Циан', img: '/frames/neon_cyan.svg', type: 'frame', price: 1500 },
    { id: 12, name: 'Стихия Огня', img: '/frames/fire_element.svg', type: 'frame', price: 1500 },
    { id: 13, name: 'Стихия Воды', img: '/frames/water_element.svg', type: 'frame', price: 1500 },
    { id: 14, name: 'Лесные Лозы', img: '/frames/nature_vines.svg', type: 'frame', price: 1500 },
    { id: 15, name: 'Королевское Золото', img: '/frames/gold_royal.svg', type: 'frame', price: 1500 },
    { id: 16, name: 'Киберпанк', img: '/frames/cyberpunk_yellow.svg', type: 'frame', price: 1500 },
    { id: 17, name: 'Тёмная Магия', img: '/frames/dark_magic.svg', type: 'frame', price: 1500 },
    { id: 18, name: 'Кровавая Луна', img: '/frames/blood_moon.svg', type: 'frame', price: 1500 },
    { id: 19, name: 'Лепестки Сакуры', img: '/frames/sakura_petals.svg', type: 'frame', price: 1500 },
    { id: 20, name: 'Меха-Броня', img: '/frames/mecha_armor.svg', type: 'frame', price: 1500 },
    { id: 21, name: 'Крылья Ангела', img: '/frames/angel_wings.svg', type: 'frame', price: 1500 },
    { id: 22, name: 'Рога Демона', img: '/frames/demon_horns.svg', type: 'frame', price: 1500 },
    { id: 23, name: 'Пиксель-Арт', img: '/frames/pixel_art.svg', type: 'frame', price: 1500 },
    { id: 24, name: 'Звёздная Ночь', img: '/frames/starry_night.svg', type: 'frame', price: 1500 },
    { id: 25, name: 'Ледяной Кристалл', img: '/frames/ice_crystal.svg', type: 'frame', price: 1500 },
    { id: 26, name: 'Любовь', img: '/frames/hearts_love.svg', type: 'frame', price: 1500 },
    { id: 27, name: 'Стальные Цепи', img: '/frames/chain_link.svg', type: 'frame', price: 1500 },
    { id: 28, name: 'Радуга', img: '/frames/rainbow_pride.svg', type: 'frame', price: 1500 },
    { id: 29, name: 'Электричество', img: '/frames/electric_shock.svg', type: 'frame', price: 1500 }
  ],
  banners: [
