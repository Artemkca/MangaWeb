...
const mockItems = [
  ...
  { id: 16, title: 'Frame 3', category: 'Рамки аватара', price: 1500, image: '/frames/frame_3.png', ageRating: '16+', discount: '-10%', oldPrice: 2000, limitedCount: 100 },
  { id: 17, title: 'Frame 4', category: 'Рамки аватара', price: 1500, image: '/frames/frame_4.png', ageRating: '18+', limitedCount: 10 },
  { id: 18, title: 'Frame Coloque Um Nome Wmistic Arena', category: 'Рамки аватара', price: 1000, image: '/frames/frame_coloque_um_nome_wmistic_arena.png', ageRating: '0+', limitedCount: 100 },
  { id: 19, title: 'Frame Kitsune', category: 'Рамки аватара', price: 3000, image: '/frames/frame_kitsune.png', ageRating: '0+', limitedCount: 50 },
  { id: 20, title: 'Frame Oni', category: 'Рамки аватара', price: 2000, image: '/frames/frame_oni.png', ageRating: '18+', discount: '-10%', oldPrice: 2500, isSubOnly: true, subPrice: 1600 },
  { id: 21, title: 'Banner 101922', category: 'Баннеры', price: 10000, image: '/banners/banner_101922.jpg', ageRating: '16+', limitedCount: 10 },
  { id: 22, title: 'Banner 11061', category: 'Баннеры', price: 3000, image: '/banners/banner_11061.jpg', ageRating: '18+', limitedCount: 100 },
  { id: 23, title: 'Banner 113415', category: 'Баннеры', price: 500, image: '/banners/banner_113415.jpg', ageRating: '18+' },
  { id: 24, title: 'Banner 1535', category: 'Баннеры', price: 0, image: '/banners/banner_1535.jpg', ageRating: '18+', limitedCount: 100 },
  { id: 25, title: 'Banner 16498', category: 'Баннеры', price: 1500, image: '/banners/banner_16498.jpg', ageRating: '0+', limitedCount: 500 },
  { id: 26, title: 'Banner 20605', category: 'Баннеры', price: 4500, image: '/banners/banner_20605.jpg', ageRating: '0+' },
  { id: 27, title: 'Banner 20958', category: 'Баннеры', price: 10000, image: '/banners/banner_20958.jpg', ageRating: '0+', isSubOnly: true, subPrice: 8000, limitedCount: 50 },
  { id: 28, title: 'Banner 21', category: 'Баннеры', price: 1500, image: '/banners/banner_21.jpg', ageRating: '0+', discount: '-10%', oldPrice: 2000 },
  { id: 29, title: 'Banner 21087', category: 'Баннеры', price: 500, image: '/banners/banner_21087.jpg', ageRating: '18+', limitedCount: 10 },
  { id: 30, title: 'Banner 21459', category: 'Баннеры', price: 10000, image: '/banners/banner_21459.jpg', ageRating: '0+', isSubOnly: true, subPrice: 8000, limitedCount: 100 },
  { id: 31, title: 'Wall 21Ok29', category: 'Обои', price: 2000, image: '/wallpapers/wall_21ok29.jpg', ageRating: '16+', discount: '-10%', oldPrice: 2500, limitedCount: 10 },
  { id: 32, title: 'Wall 21Oymx', category: 'Обои', price: 1000, image: '/wallpapers/wall_21oymx.jpg', ageRating: '18+' },
  { id: 33, title: 'Wall 21Ozq6', category: 'Обои', price: 2000, image: '/wallpapers/wall_21ozq6.jpg', ageRating: '16+', limitedCount: 10 },
  { id: 34, title: 'Wall 3Q6Kgy', category: 'Обои', price: 0, image: '/wallpapers/wall_3q6kgy.jpg', ageRating: '16+' },
  { id: 35, title: 'Wall 5Ymdk5', category: 'Обои', price: 3000, image: '/wallpapers/wall_5ymdk5.jpg', ageRating: '0+', discount: '-10%', oldPrice: 3500 },
  { id: 36, title: 'Wall 8G9Kxk', category: 'Обои', price: 500, image: '/wallpapers/wall_8g9kxk.jpg', ageRating: '18+', discount: '-10%', oldPrice: 1000, limitedCount: 10 },
  { id: 37, title: 'Wall D8O6Rm', category: 'Обои', price: 1000, image: '/wallpapers/wall_d8o6rm.jpg', ageRating: '16+', limitedCount: 10 },
  { id: 38, title: 'Wall D8Oe73', category: 'Обои', price: 1000, image: '/wallpapers/wall_d8oe73.jpg', ageRating: '0+', limitedCount: 100 },
  { id: 39, title: 'Wall E86Z6K', category: 'Обои', price: 2000, image: '/wallpapers/wall_e86z6k.jpg', ageRating: '0+', limitedCount: 100 },
  { id: 40, title: 'Wall Jey5Rp', category: 'Обои', price: 4500, image: '/wallpapers/wall_jey5rp.jpg', ageRating: '0+', discount: '-10%', oldPrice: 5000, limitedCount: 500 },
  { id: 41, title: 'Wall Jey9Kq', category: 'Обои', price: 10000, image: '/wallpapers/wall_jey9kq.jpg', ageRating: '0+', discount: '-10%', oldPrice: 10500, isSubOnly: true, subPrice: 8000, limitedCount: 10 },
  { id: 42, title: 'Wall Lyjm2R', category: 'Обои', price: 1000, image: '/wallpapers/wall_lyjm2r.jpg', ageRating: '12+', limitedCount: 500 },
  { id: 43, title: 'Wall Lyjqw2', category: 'Обои', price: 10000, image: '/wallpapers/wall_lyjqw2.jpg', ageRating: '16+', discount: '-10%', oldPrice: 10500, limitedCount: 500 },
  { id: 44, title: 'Wall Og62W7', category: 'Обои', price: 500, image: '/wallpapers/wall_og62w7.jpg', ageRating: '0+', limitedCount: 10 },
  { id: 45, title: 'Wall Po723M', category: 'Обои', price: 2000, image: '/wallpapers/wall_po723m.jpg', ageRating: '0+', limitedCount: 10 },
  { id: 46, title: 'Wall Po727E', category: 'Обои', price: 500, image: '/wallpapers/wall_po727e.jpg', ageRating: '12+' },
  { id: 47, title: 'Wall Po7M99', category: 'Обои', price: 2000, image: '/wallpapers/wall_po7m99.jpg', ageRating: '18+', limitedCount: 100 },
  { id: 48, title: 'Wall Qrm3Dl', category: 'Обои', price: 2000, image: '/wallpapers/wall_qrm3dl.jpg', ageRating: '16+', isSubOnly: true, subPrice: 1600, limitedCount: 100 },
  { id: 49, title: 'Wall Qrmro7', category: 'Обои', price: 3000, image: '/wallpapers/wall_qrmro7.jpg', ageRating: '12+', isSubOnly: true, subPrice: 2400, limitedCount: 50 },
  { id: 50, title: 'Wall Rqjvl1', category: 'Обои', price: 10000, image: '/wallpapers/wall_rqjvl1.jpg', ageRating: '0+', discount: '-10%', oldPrice: 10500 },
  { id: 51, title: 'Wall Rqp3Zj', category: 'Обои', price: 3000, image: '/wallpapers/wall_rqp3zj.jpg', ageRating: '16+', isSubOnly: true, subPrice: 2400 },
  { id: 52, title: 'Wall Vpdo98', category: 'Обои', price: 3000, image: '/wallpapers/wall_vpdo98.jpg', ageRating: '16+', limitedCount: 50 },
  { id: 53, title: 'Wall W5D11P', category: 'Обои', price: 3000, image: '/wallpapers/wall_w5d11p.jpg', ageRating: '0+' },
  { id: 54, title: 'Wall Yq2Mll', category: 'Обои', price: 1500, image: '/wallpapers/wall_yq2mll.jpg', ageRating: '0+', limitedCount: 500 }
];
